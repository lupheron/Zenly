...
import { useDriver } from '@/src/hooks/drivers/useDrivers'
    ...
    if (error || !driver) {
        return (
            <div className='relative min-h-screen pb-20 lg:pb-0'>
                ...
                <div className="flex items-center justify-center min-h-[60vh]">
                    <div className="text-center">
                        <p className="text-red-500 text-lg">Haydovchi topilmadi</p>
                        <button
                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-600">Transportturi</p>
                                    <p className="text-lg font-semibold text-gray-800">{driver.vehicle_type}</p>
                                </div>
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-600">Model</p>
                                    <p className="text-lg font-semibold text-gray-800">{driver.vehicle_model}</p>
                                </div>
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-600">Tajriba</p>
                                    <p className="text-lg font-semibold text-gray-800">{driver.experience_years} yil</p>
                                </div>
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-600">Til</p>
                                    <p className="text-lg font-semibold text-gray-800">{driver.language}</p>
                                </div>
                            </div>
                            ...
                            <div className="pt-6 border-t border-gray-200">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-600">Kunlik narx</p>
                                        <p className="text-3xl font-bold text-blue-600">${driver.price_per_day}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm text-gray-600">Holat</p>
                                        <span className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${driver.available === 'yes' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
                                            }`}>
                                            {driver.available === 'yes' ? 'Mavjud' : 'Band'}
                                        </span>
                                    </div>
                                </div>
                            </div>
